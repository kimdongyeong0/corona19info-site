...
let CONFIRMER_KOREA = "11,719";
let CONFIRMER_WORLD = "6,861,307";

let DEATHS_KOREA = "273";
let DEATHS_WORLD = "398,442";

let KO_QUARANTINE_RELEASE = "10,531";
let WO_QUARANTINE_RELEASE = "3,357,530";

let KO_DURING_TREATMENT = "915";

let CONFIRMER_KO_RAST_DAY = "(+51)";
let CONFIRMER_WO_RAST_DAY = "(+114,533)";

let DEATHS_KO_RAST_DAY = "(+0)";
let DEATHS_WO_RAST_DAY = "(+4,173)";

let KO_QUARANTINE_RELEASE_RAST_DAY = "(+25)";
let WO_QUARANTINE_RELEASE_RAST_DAY = "(+84,302)";

let KO_DURING_TREATMENT_RAST_DAY = "(+26)";
...
rastDay.innerText = CONFIRMER_KO_RAST_DAY;
rastDay2.innerText = DEATHS_KO_RAST_DAY;
rastDay3.innerText = KO_QUARANTINE_RELEASE_RAST_DAY;
rastDay4.innerText = KO_DURING_TREATMENT_RAST_DAY;
...
function onChangeCountry() {
  if (change === true) {
    ...
    rastDay.innerText = CONFIRMER_WO_RAST_DAY;
    rastDay2.innerText = DEATHS_WO_RAST_DAY;
    rastDay3.innerText = WO_QUARANTINE_RELEASE_RAST_DAY;
    rastDay4.innerText = "";
  }
}
